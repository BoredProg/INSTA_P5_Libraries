 ...
 * PovRAY Copyright (C) 2012 Martin Prout (Based on processing.org DXF export)
...
import povexport.povwriter.Degenerate;
import povexport.povwriter.PovWriter;
 ...
 * @author Martin Prout
 */
public class RawPovray extends PGraphics {
...
// ..............................................................
    ...
    protected void allocate() {
        /*
         * for (int i = 0; i < MAX_TRI_LAYERS; i++) { layerList[i] = NO_LAYER; }
         */
        setLayer(0);
    }
    ...
    // ..............................................................
    /**
     * Start the output, by creating a BufferedWriter object
     */
    @Override
    public void beginDraw() {
        ...
        if (bw == null) {
            try {
                bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(out_file),"UTF8"));
                writeHeader();
    ...
    /**
     * Finish the drawing, NB: we don't close the bw here
     */
    @Override
    public void endDraw() {
        writeFooter();
     ...
     * dispose of the pov_writer object, which in turn closes the bw. Sends
    ...
    /**
     * Access the processing sketch vertices, adjust y & z values to match
...
//        }
    ...
    public void endShape(int mode) {
        ...
        /*
         * if ((vertexCount != 0) && ((shape != LINE_STRIP) && (vertexCount !=
         * 1))) { System.err.println("Extra vertex boogers found."); }
         */
    }
}
