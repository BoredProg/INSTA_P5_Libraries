...
public class ListTrashedDocuments extends Choreography {
	...
	*/
	public ListTrashedDocuments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Writer/ListTrashedDocuments"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListTrashedDocumentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTrashedDocumentsResultSet(result);
	}
