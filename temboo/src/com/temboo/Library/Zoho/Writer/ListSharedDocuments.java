...
*/
public class ListSharedDocuments extends Choreography {

	/**
	Create a new instance of the ListSharedDocuments Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSharedDocuments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Writer/ListSharedDocuments"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSharedDocumentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSharedDocumentsResultSet(result);
	}
