...
*/
public class ListAllDocuments extends Choreography {

	/**
	Create a new instance of the ListAllDocuments Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllDocuments(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Writer/ListAllDocuments"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllDocumentsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllDocumentsResultSet(result);
	}
