...
*/
public class ListPublicSpreadsheets extends Choreography {

	/**
	Create a new instance of the ListPublicSpreadsheets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListPublicSpreadsheets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Sheet/ListPublicSpreadsheets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListPublicSpreadsheetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPublicSpreadsheetsResultSet(result);
	}
