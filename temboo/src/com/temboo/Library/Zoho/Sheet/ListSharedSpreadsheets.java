...
*/
public class ListSharedSpreadsheets extends Choreography {

	/**
	Create a new instance of the ListSharedSpreadsheets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListSharedSpreadsheets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Sheet/ListSharedSpreadsheets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListSharedSpreadsheetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListSharedSpreadsheetsResultSet(result);
	}
