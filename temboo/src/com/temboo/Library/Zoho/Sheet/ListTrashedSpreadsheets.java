...
*/
public class ListTrashedSpreadsheets extends Choreography {

	/**
	Create a new instance of the ListTrashedSpreadsheets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListTrashedSpreadsheets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Sheet/ListTrashedSpreadsheets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListTrashedSpreadsheetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTrashedSpreadsheetsResultSet(result);
	}
