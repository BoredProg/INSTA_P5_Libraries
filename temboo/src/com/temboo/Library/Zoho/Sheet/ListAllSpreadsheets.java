...
*/
public class ListAllSpreadsheets extends Choreography {

	/**
	Create a new instance of the ListAllSpreadsheets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListAllSpreadsheets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Zoho/Sheet/ListAllSpreadsheets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListAllSpreadsheetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListAllSpreadsheetsResultSet(result);
	}
