...
*/
public class ListQueues extends Choreography {

	/**
	Create a new instance of the ListQueues Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListQueues(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Queues/ListQueues"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListQueuesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListQueuesResultSet(result);
	}
