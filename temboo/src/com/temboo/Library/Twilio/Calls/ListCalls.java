...
*/
public class ListCalls extends Choreography {

	/**
	Create a new instance of the ListCalls Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListCalls(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Calls/ListCalls"));
	}
	...
	*/
	public void setParentCallSID(String value) {
		this.inputs.setInput("ParentCallSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public ListCallsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListCallsResultSet(result);
	}
