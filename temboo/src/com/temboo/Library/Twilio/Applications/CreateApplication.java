...
*/
public class CreateApplication extends Choreography {

	/**
	Create a new instance of the CreateApplication Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateApplication(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Applications/CreateApplication"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateApplicationResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateApplicationResultSet(result);
	}
