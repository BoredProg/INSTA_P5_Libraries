...
*/
public class ListApplications extends Choreography {

	/**
	Create a new instance of the ListApplications Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListApplications(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Applications/ListApplications"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListApplicationsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListApplicationsResultSet(result);
	}
