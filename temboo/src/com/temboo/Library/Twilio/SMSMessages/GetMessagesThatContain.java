...
*/
public class GetMessagesThatContain extends Choreography {

	/**
	Create a new instance of the GetMessagesThatContain Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMessagesThatContain(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/SMSMessages/GetMessagesThatContain"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMessagesThatContainResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMessagesThatContainResultSet(result);
	}
