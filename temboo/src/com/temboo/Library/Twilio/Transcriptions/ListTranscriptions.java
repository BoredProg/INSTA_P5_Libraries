...
public class ListTranscriptions extends Choreography {
	...
	*/
	public ListTranscriptions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Transcriptions/ListTranscriptions"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListTranscriptionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListTranscriptionsResultSet(result);
	}
