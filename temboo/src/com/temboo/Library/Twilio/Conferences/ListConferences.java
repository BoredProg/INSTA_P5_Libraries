...
*/
public class ListConferences extends Choreography {

	/**
	Create a new instance of the ListConferences Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListConferences(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/Conferences/ListConferences"));
	}
	...
	*/
	public void setDateCreated(String value) {
		this.inputs.setInput("DateCreated", value);
	}
	...
	*/
	public void setDateUpdated(String value) {
		this.inputs.setInput("DateUpdated", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public ListConferencesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListConferencesResultSet(result);
	}
