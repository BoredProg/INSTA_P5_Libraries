...
*/
public class ListShortCodes extends Choreography {

	/**
	Create a new instance of the ListShortCodes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListShortCodes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/ShortCodes/ListShortCodes"));
	}
	...
	*/
	public void setShortCode(String value) {
		this.inputs.setInput("ShortCode", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public ListShortCodesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListShortCodesResultSet(result);
	}
