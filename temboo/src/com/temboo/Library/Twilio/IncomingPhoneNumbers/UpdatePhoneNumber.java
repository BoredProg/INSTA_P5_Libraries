...
public class UpdatePhoneNumber extends Choreography {
	...
	*/
	public void setIncomingPhoneNumberSID(String value) {
		this.inputs.setInput("IncomingPhoneNumberSID", value);
	}
	...
	*/
	public void setNewAccountSID(String value) {
		this.inputs.setInput("NewAccountSID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdatePhoneNumberResultSet run() {
