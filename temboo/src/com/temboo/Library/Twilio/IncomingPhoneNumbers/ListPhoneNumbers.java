...
*/
public class ListPhoneNumbers extends Choreography {

	/**
	Create a new instance of the ListPhoneNumbers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListPhoneNumbers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twilio/IncomingPhoneNumbers/ListPhoneNumbers"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListPhoneNumbersResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPhoneNumbersResultSet(result);
	}
