...
*/
public class XMLToDB extends Choreography {

	/**
	Create a new instance of the XMLToDB Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public XMLToDB(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/PostgreSQL/XMLToDB"));
	}
	...
	*/
	...
	@param BigDecimal - (optional, decimal) The version of the Postgres database. Allowed values are 8 and 9 (the default).
	*/
	...
	@param String - (optional, decimal) The version of the Postgres database. Allowed values are 8 and 9 (the default).
	*/
	 ...
	 */
	@Override
	public XMLToDBResultSet run() {
		JSONObject result = super.runWithResults();
		return new XMLToDBResultSet(result);
	}
