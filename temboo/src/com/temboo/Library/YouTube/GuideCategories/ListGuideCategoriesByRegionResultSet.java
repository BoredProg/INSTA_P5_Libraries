package com.temboo.Library.YouTube.GuideCategories;
...
*/
public  class ListGuideCategoriesByRegionResultSet extends ResultSet {
		
	public ListGuideCategoriesByRegionResultSet(JSONObject doc) {
		super(doc);
	}
