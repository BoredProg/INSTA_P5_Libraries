...
public class SimilarPlaces extends Choreography {
	...
	*/
	public SimilarPlaces(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/PlacesAndGeo/SimilarPlaces"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SimilarPlacesResultSet run() {
		JSONObject result = super.runWithResults();
		return new SimilarPlacesResultSet(result);
	}
