...
*/
public class GetPlaceInformation extends Choreography {

	/**
	Create a new instance of the GetPlaceInformation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetPlaceInformation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/PlacesAndGeo/GetPlaceInformation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetPlaceInformationResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetPlaceInformationResultSet(result);
	}
