...
*/
public class GetRetweets extends Choreography {

	/**
	Create a new instance of the GetRetweets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRetweets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Tweets/GetRetweets"));
	}
	...
	*/
	...
	@param String - (optional, integer) Specifies the number of records to, up to a maximum of 100.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetRetweetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRetweetsResultSet(result);
	}
