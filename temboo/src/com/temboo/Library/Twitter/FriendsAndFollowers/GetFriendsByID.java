...
*/
public class GetFriendsByID extends Choreography {

	/**
	Create a new instance of the GetFriendsByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFriendsByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/FriendsAndFollowers/GetFriendsByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetFriendsByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFriendsByIDResultSet(result);
	}
