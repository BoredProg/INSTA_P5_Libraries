...
*/
public class IncomingFriendships extends Choreography {

	/**
	Create a new instance of the IncomingFriendships Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public IncomingFriendships(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/FriendsAndFollowers/IncomingFriendships"));
	}
	...
	*/
	 ...
	 */
	@Override
	public IncomingFriendshipsResultSet run() {
		JSONObject result = super.runWithResults();
		return new IncomingFriendshipsResultSet(result);
	}
