...
*/
public class OutgoingFriendships extends Choreography {

	/**
	Create a new instance of the OutgoingFriendships Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public OutgoingFriendships(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/FriendsAndFollowers/OutgoingFriendships"));
	}
	...
	*/
	 ...
	 */
	@Override
	public OutgoingFriendshipsResultSet run() {
		JSONObject result = super.runWithResults();
		return new OutgoingFriendshipsResultSet(result);
	}
