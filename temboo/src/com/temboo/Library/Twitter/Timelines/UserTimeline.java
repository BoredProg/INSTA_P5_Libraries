...
*/
public class UserTimeline extends Choreography {

	/**
	Create a new instance of the UserTimeline Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UserTimeline(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Timelines/UserTimeline"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UserTimelineResultSet run() {
		JSONObject result = super.runWithResults();
		return new UserTimelineResultSet(result);
	}
