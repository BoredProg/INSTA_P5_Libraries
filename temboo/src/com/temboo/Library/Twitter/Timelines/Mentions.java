...
*/
public class Mentions extends Choreography {

	/**
	Create a new instance of the Mentions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Mentions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Timelines/Mentions"));
	}
	...
	*/
	...
	@param String - (optional, integer) Specifies the number of tweets to retrieve. Must be less than or equal to 200. Defaults to 20.
	*/
	...
	*/
	...
	@param String - (optional, boolean) When set to true, each tweet returned in a timeline will include a user object including only the status authors numerical ID. Defaults to false, which returns the complete user object.
	*/
	 ...
	 */
	@Override
	public MentionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new MentionsResultSet(result);
	}
