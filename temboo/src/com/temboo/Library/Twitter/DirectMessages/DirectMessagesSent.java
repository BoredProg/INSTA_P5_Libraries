...
*/
public class DirectMessagesSent extends Choreography {

	/**
	Create a new instance of the DirectMessagesSent Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DirectMessagesSent(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/DirectMessages/DirectMessagesSent"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DirectMessagesSentResultSet run() {
		JSONObject result = super.runWithResults();
		return new DirectMessagesSentResultSet(result);
	}
