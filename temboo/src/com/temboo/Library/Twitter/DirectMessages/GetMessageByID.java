...
*/
public class GetMessageByID extends Choreography {

	/**
	Create a new instance of the GetMessageByID Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMessageByID(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/DirectMessages/GetMessageByID"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMessageByIDResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMessageByIDResultSet(result);
	}
