...
public class DestroyDirectMessage extends Choreography {
	...
	*/
	public DestroyDirectMessage(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/DirectMessages/DestroyDirectMessage"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DestroyDirectMessageResultSet run() {
		JSONObject result = super.runWithResults();
		return new DestroyDirectMessageResultSet(result);
	}
