...
*/
public class GetMembers extends Choreography {

	/**
	Create a new instance of the GetMembers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetMembers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/GetMembers"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetMembersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetMembersResultSet(result);
	}
