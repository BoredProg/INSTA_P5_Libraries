...
*/
public class ShowMember extends Choreography {

	/**
	Create a new instance of the ShowMember Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowMember(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/ShowMember"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowMemberResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowMemberResultSet(result);
	}
