...
*/
public class DestroyList extends Choreography {

	/**
	Create a new instance of the DestroyList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DestroyList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/DestroyList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DestroyListResultSet run() {
		JSONObject result = super.runWithResults();
		return new DestroyListResultSet(result);
	}
