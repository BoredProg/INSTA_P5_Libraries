...
*/
public class CreateSubscriber extends Choreography {

	/**
	Create a new instance of the CreateSubscriber Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateSubscriber(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/CreateSubscriber"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateSubscriberResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateSubscriberResultSet(result);
	}
