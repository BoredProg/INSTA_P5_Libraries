...
*/
public class GetOwnedLists extends Choreography {

	/**
	Create a new instance of the GetOwnedLists Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetOwnedLists(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/GetOwnedLists"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetOwnedListsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetOwnedListsResultSet(result);
	}
