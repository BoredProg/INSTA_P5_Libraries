...
*/
public class ShowList extends Choreography {

	/**
	Create a new instance of the ShowList Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ShowList(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/ShowList"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowListResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowListResultSet(result);
	}
