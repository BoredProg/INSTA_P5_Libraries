...
*/
public class CreateMember extends Choreography {

	/**
	Create a new instance of the CreateMember Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateMember(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/CreateMember"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateMemberResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateMemberResultSet(result);
	}
