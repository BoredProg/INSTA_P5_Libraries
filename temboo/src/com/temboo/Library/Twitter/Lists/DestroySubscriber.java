...
public class DestroySubscriber extends Choreography {
	...
	*/
	public DestroySubscriber(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Lists/DestroySubscriber"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DestroySubscriberResultSet run() {
		JSONObject result = super.runWithResults();
		return new DestroySubscriberResultSet(result);
	}
