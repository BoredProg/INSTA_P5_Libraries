...
*/
public class VerifyCredentials extends Choreography {

	/**
	Create a new instance of the VerifyCredentials Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VerifyCredentials(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Users/VerifyCredentials"));
	}
	...
	*/
	 ...
	 */
	@Override
	public VerifyCredentialsResultSet run() {
		JSONObject result = super.runWithResults();
		return new VerifyCredentialsResultSet(result);
	}
