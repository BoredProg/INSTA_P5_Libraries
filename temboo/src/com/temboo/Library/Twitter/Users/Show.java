...
*/
public class Show extends Choreography {

	/**
	Create a new instance of the Show Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Show(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Users/Show"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ShowResultSet run() {
		JSONObject result = super.runWithResults();
		return new ShowResultSet(result);
	}
