...
*/
public class GetAccountSettings extends Choreography {

	/**
	Create a new instance of the GetAccountSettings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAccountSettings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Users/GetAccountSettings"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAccountSettingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAccountSettingsResultSet(result);
	}
