...
*/
public class Lookup extends Choreography {

	/**
	Create a new instance of the Lookup Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Lookup(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Users/Lookup"));
	}
	...
	*/
	...
	@param String - (conditional, string) A comma-separated list of up to 100 user IDs. Required if ScreenName isn't specified.
	*/
	 ...
	 */
	@Override
	public LookupResultSet run() {
		JSONObject result = super.runWithResults();
		return new LookupResultSet(result);
	}
