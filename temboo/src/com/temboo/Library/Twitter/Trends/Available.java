...
*/
public class Available extends Choreography {

	/**
	Create a new instance of the Available Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Available(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Trends/Available"));
	}
	...
	*/
	 ...
	 */
	@Override
	public AvailableResultSet run() {
		JSONObject result = super.runWithResults();
		return new AvailableResultSet(result);
	}
