...
*/
public class CreateFavorite extends Choreography {

	/**
	Create a new instance of the CreateFavorite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateFavorite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Favorites/CreateFavorite"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateFavoriteResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateFavoriteResultSet(result);
	}
