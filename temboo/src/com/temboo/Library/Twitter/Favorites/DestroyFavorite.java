...
*/
public class DestroyFavorite extends Choreography {

	/**
	Create a new instance of the DestroyFavorite Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DestroyFavorite(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Favorites/DestroyFavorite"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DestroyFavoriteResultSet run() {
		JSONObject result = super.runWithResults();
		return new DestroyFavoriteResultSet(result);
	}
