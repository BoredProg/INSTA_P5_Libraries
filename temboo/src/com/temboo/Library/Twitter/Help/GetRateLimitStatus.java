package com.temboo.Library.Twitter.Help;
...
*/
public class GetRateLimitStatus extends Choreography {

	/**
	Create a new instance of the GetRateLimitStatus Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetRateLimitStatus(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Twitter/Help/GetRateLimitStatus"));
	}
	...
	*/
	public void setResources(String value) {
		this.inputs.setInput("Resources", value);
	}
	 ...
	 */
	@Override
	public GetRateLimitStatusResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetRateLimitStatusResultSet(result);
	}
