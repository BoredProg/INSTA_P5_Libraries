...
*/
public class RandomWords extends Choreography {

	/**
	Create a new instance of the RandomWords Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RandomWords(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Wordnik/Words/RandomWords"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RandomWordsResultSet run() {
		JSONObject result = super.runWithResults();
		return new RandomWordsResultSet(result);
	}
