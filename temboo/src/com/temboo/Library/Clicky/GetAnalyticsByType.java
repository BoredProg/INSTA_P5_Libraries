...
*/
public class GetAnalyticsByType extends Choreography {

	/**
	Create a new instance of the GetAnalyticsByType Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAnalyticsByType(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Clicky/GetAnalyticsByType"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAnalyticsByTypeResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAnalyticsByTypeResultSet(result);
	}
