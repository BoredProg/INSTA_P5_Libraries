...
public class ListPosts extends Choreography {
	...
	*/
	public ListPosts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Users/ListPosts"));
	}
	...
	*/
	public void setIncluded(String value) {
		this.inputs.setInput("Included", value);
	}
	...
	*/
	...
	@param String - (optional, string) Indicates the relations to include with your response. Valid values are: forum and thread.
	*/
