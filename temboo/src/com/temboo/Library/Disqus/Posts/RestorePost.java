...
*/
public class RestorePost extends Choreography {

	/**
	Create a new instance of the RestorePost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RestorePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Posts/RestorePost"));
	}
	...
	*/
	...
	@param String - (required, integer) The post ID which is to be restored (undeleted).
	*/
	...
	*/
	 ...
	 */
	@Override
	public RestorePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new RestorePostResultSet(result);
	}
