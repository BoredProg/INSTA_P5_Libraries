...
*/
public class VoteOnPost extends Choreography {

	/**
	Create a new instance of the VoteOnPost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public VoteOnPost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Disqus/Posts/VoteOnPost"));
	}
	...
	*/
	...
	@param String - (required, integer) The post ID for which a vote is being registered.
	*/
	...
	*/
	...
	/** 
	Set the value of the Vote input for this Choreo as a String. 

	@param String - (required, integer) A numeric value for your vote. Valid choices are: -1, 0, or 1.
	*/
	...
	*/
	 ...
	 */
	@Override
	public VoteOnPostResultSet run() {
		JSONObject result = super.runWithResults();
		return new VoteOnPostResultSet(result);
	}
