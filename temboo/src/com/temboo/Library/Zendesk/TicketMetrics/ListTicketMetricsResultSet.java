package com.temboo.Library.Zendesk.TicketMetrics;
...
*/
public  class ListTicketMetricsResultSet extends ResultSet {
		
	public ListTicketMetricsResultSet(JSONObject doc) {
		super(doc);
	}
