package com.temboo.Library.Zendesk.MonitoredTwitterHandles;
...
*/
public  class ListMonitoredTwitterHandlesResultSet extends ResultSet {
		
	public ListMonitoredTwitterHandlesResultSet(JSONObject doc) {
		super(doc);
	}
