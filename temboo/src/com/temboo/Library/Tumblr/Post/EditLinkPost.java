...
*/
public class EditLinkPost extends Choreography {

	/**
	Create a new instance of the EditLinkPost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditLinkPost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/EditLinkPost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public EditLinkPostResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditLinkPostResultSet(result);
	}
