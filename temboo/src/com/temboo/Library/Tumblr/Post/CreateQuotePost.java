...
*/
public class CreateQuotePost extends Choreography {

	/**
	Create a new instance of the CreateQuotePost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateQuotePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateQuotePost"));
	}
	...
	*/
	public void setQuote(String value) {
		this.inputs.setInput("Quote", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateQuotePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateQuotePostResultSet(result);
	}
