...
public class CreateAudioPostWithURL extends Choreography {
	...
	*/
	public CreateAudioPostWithURL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateAudioPostWithURL"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateAudioPostWithURLResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateAudioPostWithURLResultSet(result);
	}
