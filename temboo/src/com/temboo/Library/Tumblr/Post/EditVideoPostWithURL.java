...
*/
public class EditVideoPostWithURL extends Choreography {

	/**
	Create a new instance of the EditVideoPostWithURL Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditVideoPostWithURL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/EditVideoPostWithURL"));
	}
	...
	*/
	 ...
	 */
	@Override
	public EditVideoPostWithURLResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditVideoPostWithURLResultSet(result);
	}
