...
*/
public class CreateChatPost extends Choreography {

	/**
	Create a new instance of the CreateChatPost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateChatPost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateChatPost"));
	}
	...
	*/
	public void setConversation(String value) {
		this.inputs.setInput("Conversation", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateChatPostResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateChatPostResultSet(result);
	}
