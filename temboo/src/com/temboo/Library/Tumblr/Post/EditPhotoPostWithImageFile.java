...
*/
public class EditPhotoPostWithImageFile extends Choreography {

	/**
	Create a new instance of the EditPhotoPostWithImageFile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditPhotoPostWithImageFile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/EditPhotoPostWithImageFile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public EditPhotoPostWithImageFileResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditPhotoPostWithImageFileResultSet(result);
	}
