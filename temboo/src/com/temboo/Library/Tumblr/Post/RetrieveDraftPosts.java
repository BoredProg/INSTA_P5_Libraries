...
*/
public class RetrieveDraftPosts extends Choreography {

	/**
	Create a new instance of the RetrieveDraftPosts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveDraftPosts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/RetrieveDraftPosts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveDraftPostsResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveDraftPostsResultSet(result);
	}
