...
*/
public class UnlikePost extends Choreography {

	/**
	Create a new instance of the UnlikePost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UnlikePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/UnlikePost"));
	}
	...
	*/
	...
	@param String - (required, integer) The ID of the post you want to unlike.
	*/
	...
	*/
	 ...
	 */
	@Override
	public UnlikePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new UnlikePostResultSet(result);
	}
