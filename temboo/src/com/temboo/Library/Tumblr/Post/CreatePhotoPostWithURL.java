...
*/
public class CreatePhotoPostWithURL extends Choreography {

	/**
	Create a new instance of the CreatePhotoPostWithURL Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreatePhotoPostWithURL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreatePhotoPostWithURL"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreatePhotoPostWithURLResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreatePhotoPostWithURLResultSet(result);
	}
