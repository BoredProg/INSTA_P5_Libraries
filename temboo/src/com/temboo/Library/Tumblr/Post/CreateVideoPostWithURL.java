...
*/
public class CreateVideoPostWithURL extends Choreography {

	/**
	Create a new instance of the CreateVideoPostWithURL Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateVideoPostWithURL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateVideoPostWithURL"));
	}
	...
	*/
	public void setEmbed(String value) {
		this.inputs.setInput("Embed", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateVideoPostWithURLResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateVideoPostWithURLResultSet(result);
	}
