...
*/
public class EditQuotePost extends Choreography {

	/**
	Create a new instance of the EditQuotePost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditQuotePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/EditQuotePost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public EditQuotePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditQuotePostResultSet(result);
	}
