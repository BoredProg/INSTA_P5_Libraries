...
*/
public class RetrieveSubmissionPosts extends Choreography {

	/**
	Create a new instance of the RetrieveSubmissionPosts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveSubmissionPosts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/RetrieveSubmissionPosts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveSubmissionPostsResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveSubmissionPostsResultSet(result);
	}
