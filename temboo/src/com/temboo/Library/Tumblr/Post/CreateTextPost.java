...
*/
public class CreateTextPost extends Choreography {

	/**
	Create a new instance of the CreateTextPost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateTextPost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateTextPost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateTextPostResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateTextPostResultSet(result);
	}
