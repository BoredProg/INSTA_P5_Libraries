...
*/
public class CreateLinkPost extends Choreography {

	/**
	Create a new instance of the CreateLinkPost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreateLinkPost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/CreateLinkPost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreateLinkPostResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreateLinkPostResultSet(result);
	}
