...
*/
public class EditAudioPostWithURL extends Choreography {

	/**
	Create a new instance of the EditAudioPostWithURL Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public EditAudioPostWithURL(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/Post/EditAudioPostWithURL"));
	}
	...
	*/
	public void setExternalURL(String value) {
		this.inputs.setInput("ExternalURL", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public EditAudioPostWithURLResultSet run() {
		JSONObject result = super.runWithResults();
		return new EditAudioPostWithURLResultSet(result);
	}
