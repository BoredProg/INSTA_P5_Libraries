...
*/
public class RetrieveFollowedBlogsForUser extends Choreography {

	/**
	Create a new instance of the RetrieveFollowedBlogsForUser Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveFollowedBlogsForUser(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Tumblr/User/RetrieveFollowedBlogsForUser"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveFollowedBlogsForUserResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveFollowedBlogsForUserResultSet(result);
	}
