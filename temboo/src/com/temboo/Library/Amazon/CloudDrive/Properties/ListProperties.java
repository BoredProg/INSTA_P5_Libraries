...
*/
public class ListProperties extends Choreography {

	/**
	Create a new instance of the ListProperties Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListProperties(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Properties/ListProperties"));
	}
	...
	*/
	...
	@param Integer - (optional, integer) Whether or not to perform a retry sequence if a throttling error occurs. Set to true to enable this feature. The request will be retried up-to five times when enabled.
	*/
	public void setHandleRequestThrottling(Integer value) {
	...
	@param String - (optional, integer) Whether or not to perform a retry sequence if a throttling error occurs. Set to true to enable this feature. The request will be retried up-to five times when enabled.
	*/
	...
	@param String - (required, string) The ID of the file or folder to list properties for.
	*/
	...
	*/
	...
	@param String - (required, string) The "owner" of properties to list.
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListPropertiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListPropertiesResultSet(result);
	}
