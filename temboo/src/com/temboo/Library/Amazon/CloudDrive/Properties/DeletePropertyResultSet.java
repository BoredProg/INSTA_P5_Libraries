...
*/
public  class DeletePropertyResultSet extends ResultSet {
		
	public DeletePropertyResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	...
	@return String - (integer) The response status code returned from Amazon. A 204 is returned for a successful delete operation.
	*/
