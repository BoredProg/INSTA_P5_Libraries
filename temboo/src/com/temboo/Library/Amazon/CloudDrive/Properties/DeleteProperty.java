...
*/
public class DeleteProperty extends Choreography {

	/**
	Create a new instance of the DeleteProperty Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteProperty(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Properties/DeleteProperty"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the file or folder associated with the property being deleted.
	*/
	...
	@param String - (required, string) The key of the properties which needs to be deleted.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeletePropertyResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeletePropertyResultSet(result);
	}
