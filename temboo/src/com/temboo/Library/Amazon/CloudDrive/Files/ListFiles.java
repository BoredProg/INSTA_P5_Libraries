...
*/
public class ListFiles extends Choreography {

	/**
	Create a new instance of the ListFiles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListFiles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Files/ListFiles"));
	}
	...
	*/
	...
	@param String - (optional, string) A filter used to narrow the result set (e.g., name:MyFile.txt). The default value is "kind:FILE". To a make a request using no filters, you can pass "none".
	*/
	...
	*/
	 ...
	 */
	@Override
	public ListFilesResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListFilesResultSet(result);
	}
