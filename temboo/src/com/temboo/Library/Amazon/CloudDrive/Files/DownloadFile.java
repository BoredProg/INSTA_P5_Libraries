...
*/
public class DownloadFile extends Choreography {

	/**
	Create a new instance of the DownloadFile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DownloadFile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Files/DownloadFile"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the file to return content for.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DownloadFileResultSet run() {
		JSONObject result = super.runWithResults();
		return new DownloadFileResultSet(result);
	}
