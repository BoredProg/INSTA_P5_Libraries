...
*/
public class GetFolderMetadata extends Choreography {

	/**
	Create a new instance of the GetFolderMetadata Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFolderMetadata(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Folders/GetFolderMetadata"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the folder to return metadata for.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetFolderMetadataResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFolderMetadataResultSet(result);
	}
