...
*/
public  class SetupAccountResultSet extends ResultSet {
		
	public SetupAccountResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	...
	@return String - (integer) The response status code returned from Amazon.
	*/
