...
public class Restore extends Choreography {
	...
	*/
	public Restore(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/CloudDrive/Trash/Restore"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the file or folder to restore.
	*/
