package com.temboo.Library.Amazon.LoginWithAmazon;
...
public class FinalizeOAuth extends Choreography {
	...
	*/
	public FinalizeOAuth(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Amazon/LoginWithAmazon/FinalizeOAuth"));
	}
	...
	*/
	...
	@param String - (required, string) The Client ID provided by Amazon.
	*/
	...
	@param String - (required, string) The Client Secret provided by Amazon.
	*/
