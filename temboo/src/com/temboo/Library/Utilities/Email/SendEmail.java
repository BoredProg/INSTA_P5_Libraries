...
public class SendEmail extends Choreography {
	...
	*/
	...
	@param String - (required, integer) Specify the port number (i.e. 25 or 465).
	*/
	...
	*/
	...
	@param String - (optional, boolean) Set to 1 to connect over SSL. Set to 0 for no SSL. Defaults to 1.
	*/
