...
public class UpdatePost extends Choreography {
	...
	*/
	public UpdatePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Posts/UpdatePost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdatePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdatePostResultSet(result);
	}
