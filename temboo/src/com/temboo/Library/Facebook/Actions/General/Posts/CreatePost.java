...
*/
public class CreatePost extends Choreography {

	/**
	Create a new instance of the CreatePost Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CreatePost(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Posts/CreatePost"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CreatePostResultSet run() {
		JSONObject result = super.runWithResults();
		return new CreatePostResultSet(result);
	}
