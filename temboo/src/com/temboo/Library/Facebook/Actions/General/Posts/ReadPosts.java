...
*/
public class ReadPosts extends Choreography {

	/**
	Create a new instance of the ReadPosts Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ReadPosts(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Actions/General/Posts/ReadPosts"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ReadPostsResultSet run() {
		JSONObject result = super.runWithResults();
		return new ReadPostsResultSet(result);
	}
