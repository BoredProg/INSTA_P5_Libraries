...
public class InitializeOAuth extends Choreography {
	...
	*/
	...
	@param String - (optional, string) A comma-separated list of permissions to request access for (i.e. "publish_actions,read_mailbox"). For more information see documentation.
	*/
