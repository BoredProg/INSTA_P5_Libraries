...
*/
public class Checkins extends Choreography {

	/**
	Create a new instance of the Checkins Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Checkins(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Checkins"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CheckinsResultSet run() {
		JSONObject result = super.runWithResults();
		return new CheckinsResultSet(result);
	}
