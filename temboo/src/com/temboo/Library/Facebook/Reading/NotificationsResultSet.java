...
/**
	A ResultSet with methods tailored to the values returned by the Notifications Choreo.
	The ResultSet object is used to retrieve the results of a Choreo execution.
*/
public  class NotificationsResultSet extends ResultSet {
		
	public NotificationsResultSet(JSONObject doc) {
		super(doc);
	}
