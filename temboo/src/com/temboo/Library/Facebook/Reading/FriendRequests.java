...
*/
public class FriendRequests extends Choreography {

	/**
	Create a new instance of the FriendRequests Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public FriendRequests(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/FriendRequests"));
	}
	...
	*/
	 ...
	 */
	@Override
	public FriendRequestsResultSet run() {
		JSONObject result = super.runWithResults();
		return new FriendRequestsResultSet(result);
	}
