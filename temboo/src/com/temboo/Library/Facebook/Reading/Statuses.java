...
*/
public class Statuses extends Choreography {

	/**
	Create a new instance of the Statuses Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Statuses(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Statuses"));
	}
	...
	*/
	 ...
	 */
	@Override
	public StatusesResultSet run() {
		JSONObject result = super.runWithResults();
		return new StatusesResultSet(result);
	}
