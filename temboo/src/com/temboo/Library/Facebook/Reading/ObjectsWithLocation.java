...
*/
public class ObjectsWithLocation extends Choreography {

	/**
	Create a new instance of the ObjectsWithLocation Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ObjectsWithLocation(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/ObjectsWithLocation"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ObjectsWithLocationResultSet run() {
		JSONObject result = super.runWithResults();
		return new ObjectsWithLocationResultSet(result);
	}
