...
*/
public  class FriendshipExistsResultSet extends ResultSet {
		
	public FriendshipExistsResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	...
	@return String - (boolean) Returns as true or false depending on whether or not the UserID specified corresponds to a friend of the acting user.
	*/
	public String getIsFriend() {
		return this.getResultString("IsFriend");
	}
}