...
*/
public class Notes extends Choreography {

	/**
	Create a new instance of the Notes Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public Notes(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Facebook/Reading/Notes"));
	}
	...
	*/
	 ...
	 */
	@Override
	public NotesResultSet run() {
		JSONObject result = super.runWithResults();
		return new NotesResultSet(result);
	}
