...
*/
public class RetrieveActivites extends Choreography {

	/**
	Create a new instance of the RetrieveActivites Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveActivites(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/RunKeeper/FitnessActivities/RetrieveActivites"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveActivitesResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveActivitesResultSet(result);
	}
