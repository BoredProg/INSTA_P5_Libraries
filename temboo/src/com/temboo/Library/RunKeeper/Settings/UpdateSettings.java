...
*/
public class UpdateSettings extends Choreography {

	/**
	Create a new instance of the UpdateSettings Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public UpdateSettings(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/RunKeeper/Settings/UpdateSettings"));
	}
	...
	*/
	public void setSettings(String value) {
		this.inputs.setInput("Settings", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public UpdateSettingsResultSet run() {
		JSONObject result = super.runWithResults();
		return new UpdateSettingsResultSet(result);
	}
