...
*/
public class RetrieveActivities extends Choreography {

	/**
	Create a new instance of the RetrieveActivities Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveActivities(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/RunKeeper/StrengthTrainingActivities/RetrieveActivities"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveActivitiesResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveActivitiesResultSet(result);
	}
