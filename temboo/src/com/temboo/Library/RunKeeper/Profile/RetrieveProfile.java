...
public class RetrieveProfile extends Choreography {
	...
	*/
	public RetrieveProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/RunKeeper/Profile/RetrieveProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveProfileResultSet(result);
	}
