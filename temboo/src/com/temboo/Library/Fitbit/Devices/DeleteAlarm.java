...
*/
public class DeleteAlarm extends Choreography {

	/**
	Create a new instance of the DeleteAlarm Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteAlarm(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Devices/DeleteAlarm"));
	}
	...
	*/
	...
	@param String - (required, string) The ID of the alarm to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteAlarmResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteAlarmResultSet(result);
	}
