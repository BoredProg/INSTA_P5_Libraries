...
*/
public class AddAlarm extends Choreography {

	/**
	Create a new instance of the AddAlarm Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddAlarm(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Fitbit/Devices/AddAlarm"));
	}
	...
	*/
	...
	@param Integer - (optional, integer) The maximum snooze count.
	*/
	...
	@param String - (optional, integer) The maximum snooze count.
	*/
	...
	@param Integer - (optional, integer) The number of minutes in between alarms when using the snooze option.
	*/
	...
	@param String - (optional, integer) The number of minutes in between alarms when using the snooze option.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddAlarmResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddAlarmResultSet(result);
	}
