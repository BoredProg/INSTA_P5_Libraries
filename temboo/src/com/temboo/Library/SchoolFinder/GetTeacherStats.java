...
*/
public class GetTeacherStats extends Choreography {

	/**
	Create a new instance of the GetTeacherStats Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetTeacherStats(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/SchoolFinder/GetTeacherStats"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetTeacherStatsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetTeacherStatsResultSet(result);
	}
