...
*/
public class DeleteFileOrFolder extends Choreography {

	/**
	Create a new instance of the DeleteFileOrFolder Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteFileOrFolder(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/FileOperations/DeleteFileOrFolder"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteFileOrFolderResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteFileOrFolderResultSet(result);
	}
