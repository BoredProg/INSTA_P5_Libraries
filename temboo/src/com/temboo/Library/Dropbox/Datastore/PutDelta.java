...
*/
public class PutDelta extends Choreography {

	/**
	Create a new instance of the PutDelta Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public PutDelta(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/PutDelta"));
	}
	...
	*/
	...
	/** 
	Set the value of the Changes input for this Choreo. 

	@param String - (required, json) A JSON-encoded list of changes. See Choreo notes for formatting details.
	*/
	public void setChanges(String value) {
		this.inputs.setInput("Changes", value);
	}
	...
	*/
	...
	/** 
	Set the value of the Nonce input for this Choreo. 

	@param String - (optional, string) An optional dbase64 string (up to 100 characters) used to uniquely identify this delta. If set to "default" a nonce will be auto-generated.
	*/
	public void setNonce(String value) {
		this.inputs.setInput("Nonce", value);
	}
	...
	*/
	...
	@param String - (required, string) The revision from which to start.
	*/
	 ...
	 */
	@Override
	public PutDeltaResultSet run() {
		JSONObject result = super.runWithResults();
		return new PutDeltaResultSet(result);
	}
