...
*/
public class GetDeltas extends Choreography {

	/**
	Create a new instance of the GetDeltas Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDeltas(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/GetDeltas"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetDeltasResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDeltasResultSet(result);
	}
