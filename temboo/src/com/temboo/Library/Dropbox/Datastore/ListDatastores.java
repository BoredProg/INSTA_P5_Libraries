...
*/
public class ListDatastores extends Choreography {

	/**
	Create a new instance of the ListDatastores Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public ListDatastores(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/ListDatastores"));
	}
	...
	*/
	 ...
	 */
	@Override
	public ListDatastoresResultSet run() {
		JSONObject result = super.runWithResults();
		return new ListDatastoresResultSet(result);
	}
