...
*/
public class GetOrCreateDatastore extends Choreography {

	/**
	Create a new instance of the GetOrCreateDatastore Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetOrCreateDatastore(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/GetOrCreateDatastore"));
	}
	...
	*/
	...
	/** 
	Set the value of the DatastoreID input for this Choreo. 

	@param String - (required, string) The private ID for a datastore to create or to verify.
	*/
	public void setDatastoreID(String value) {
		this.inputs.setInput("DatastoreID", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetOrCreateDatastoreResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetOrCreateDatastoreResultSet(result);
	}
