...
*/
public class GetSnapshot extends Choreography {

	/**
	Create a new instance of the GetSnapshot Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSnapshot(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/GetSnapshot"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSnapshotResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSnapshotResultSet(result);
	}
