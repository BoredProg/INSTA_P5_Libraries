...
*/
public class DeleteDatastore extends Choreography {

	/**
	Create a new instance of the DeleteDatastore Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteDatastore(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/Datastore/DeleteDatastore"));
	}
	...
	*/
	...
	@param String - (required, string) The handle of an existing datastore to delete.
	*/
	...
	*/
	 ...
	 */
	@Override
	public DeleteDatastoreResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteDatastoreResultSet(result);
	}
