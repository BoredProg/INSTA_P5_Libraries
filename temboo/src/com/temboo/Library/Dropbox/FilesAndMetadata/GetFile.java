...
public class GetFile extends Choreography {
	...
	*/
	...
	@param Boolean - (optional, boolean) File content is returned as Base64 encoded data by default. If the file's mime-type is plain/text, and you wish to return the decoded file contents, you can set this to false.
	*/
	...
	@param String - (optional, boolean) File content is returned as Base64 encoded data by default. If the file's mime-type is plain/text, and you wish to return the decoded file contents, you can set this to false.
	*/
