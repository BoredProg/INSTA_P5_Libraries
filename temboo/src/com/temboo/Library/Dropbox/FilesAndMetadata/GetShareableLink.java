...
*/
public class GetShareableLink extends Choreography {

	/**
	Create a new instance of the GetShareableLink Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetShareableLink(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/FilesAndMetadata/GetShareableLink"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetShareableLinkResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetShareableLinkResultSet(result);
	}
