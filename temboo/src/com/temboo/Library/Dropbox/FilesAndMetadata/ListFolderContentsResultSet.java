...
*/
public  class ListFolderContentsResultSet extends ResultSet {
		
	public ListFolderContentsResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	...
	@return String - (integer) The response status code returned from Dropbox.
	*/
