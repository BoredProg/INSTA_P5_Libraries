...
*/
public class GetDownloadLink extends Choreography {

	/**
	Create a new instance of the GetDownloadLink Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetDownloadLink(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/FilesAndMetadata/GetDownloadLink"));
	}
	...
	*/
	...
	@param String - (required, string) The path to the file or folder you want to return a download link for (i.e. /RootFolder/SubFolder/MyFile.txt).
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetDownloadLinkResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetDownloadLinkResultSet(result);
	}
