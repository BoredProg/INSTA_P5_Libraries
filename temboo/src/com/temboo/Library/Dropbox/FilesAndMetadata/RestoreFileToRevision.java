...
*/
public class RestoreFileToRevision extends Choreography {

	/**
	Create a new instance of the RestoreFileToRevision Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RestoreFileToRevision(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/FilesAndMetadata/RestoreFileToRevision"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RestoreFileToRevisionResultSet run() {
		JSONObject result = super.runWithResults();
		return new RestoreFileToRevisionResultSet(result);
	}
