...
*/
public class GetFileRevisions extends Choreography {

	/**
	Create a new instance of the GetFileRevisions Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetFileRevisions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Dropbox/FilesAndMetadata/GetFileRevisions"));
	}
	...
	*/
	public void setRevisionLimit(Integer value) {
		this.inputs.setInput("RevisionLimit", value);
	}

	/** 
	Set the value of the RevisionLimit input for this Choreo as a String. 

	@param String - (optional, integer) Default is 10. Max is 1,000. When listing a file, the service will not report listings containing more than the amount specified here.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetFileRevisionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetFileRevisionsResultSet(result);
	}
