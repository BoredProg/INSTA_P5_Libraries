...
*/
public class GetUserConnections extends Choreography {

	/**
	Create a new instance of the GetUserConnections Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUserConnections(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/PeopleAndConnections/GetUserConnections"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUserConnectionsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUserConnectionsResultSet(result);
	}
