...
*/
public class GetShare extends Choreography {

	/**
	Create a new instance of the GetShare Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetShare(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/ShareAndSocialStream/GetShare"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetShareResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetShareResultSet(result);
	}
