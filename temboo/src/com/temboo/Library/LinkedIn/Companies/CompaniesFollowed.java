...
*/
public class CompaniesFollowed extends Choreography {

	/**
	Create a new instance of the CompaniesFollowed Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CompaniesFollowed(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/CompaniesFollowed"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CompaniesFollowedResultSet run() {
		JSONObject result = super.runWithResults();
		return new CompaniesFollowedResultSet(result);
	}
