...
*/
public class GetCompanyProfiles extends Choreography {

	/**
	Create a new instance of the GetCompanyProfiles Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCompanyProfiles(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetCompanyProfiles"));
	}
	...
	*/
	public void setCompanies(String value) {
		this.inputs.setInput("Companies", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetCompanyProfilesResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCompanyProfilesResultSet(result);
	}
