...
*/
public class SuggestedCompaniesToFollow extends Choreography {

	/**
	Create a new instance of the SuggestedCompaniesToFollow Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SuggestedCompaniesToFollow(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/SuggestedCompaniesToFollow"));
	}
	...
	*/
	 ...
	 */
	@Override
	public SuggestedCompaniesToFollowResultSet run() {
		JSONObject result = super.runWithResults();
		return new SuggestedCompaniesToFollowResultSet(result);
	}
