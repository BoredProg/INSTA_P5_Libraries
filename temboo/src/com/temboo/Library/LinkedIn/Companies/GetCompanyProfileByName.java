...
*/
public class GetCompanyProfileByName extends Choreography {

	/**
	Create a new instance of the GetCompanyProfileByName Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetCompanyProfileByName(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Companies/GetCompanyProfileByName"));
	}
	...
	*/
	public void setCompanyName(Integer value) {
		this.inputs.setInput("CompanyName", value);
	}

	/** 
	Set the value of the CompanyName input for this Choreo as a String. 

	@param String - (required, integer) The unique string identifier for a company.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetCompanyProfileByNameResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetCompanyProfileByNameResultSet(result);
	}
