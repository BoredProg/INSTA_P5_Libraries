...
*/
public class GetBookmarkedJobs extends Choreography {

	/**
	Create a new instance of the GetBookmarkedJobs Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetBookmarkedJobs(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Jobs/GetBookmarkedJobs"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetBookmarkedJobsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetBookmarkedJobsResultSet(result);
	}
