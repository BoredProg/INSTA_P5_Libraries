...
*/
public class GetSuggestedJobs extends Choreography {

	/**
	Create a new instance of the GetSuggestedJobs Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetSuggestedJobs(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Jobs/GetSuggestedJobs"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetSuggestedJobsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetSuggestedJobsResultSet(result);
	}
