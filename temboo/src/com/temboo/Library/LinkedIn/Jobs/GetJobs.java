...
*/
public class GetJobs extends Choreography {

	/**
	Create a new instance of the GetJobs Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetJobs(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Jobs/GetJobs"));
	}
	...
	*/
	...
	@param String - (required, integer) A LinkedIn assigned job ID.
	*/
	...
	*/
	 ...
	 */
	@Override
	public GetJobsResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetJobsResultSet(result);
	}
