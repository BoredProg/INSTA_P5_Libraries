...
*/
public class SearchJobsByZipcodeAndCountryCode extends Choreography {

	/**
	Create a new instance of the SearchJobsByZipcodeAndCountryCode Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public SearchJobsByZipcodeAndCountryCode(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Jobs/SearchJobsByZipcodeAndCountryCode"));
	}
	...
	*/
	...
	@param String - (required, string) Enter a postal (zip) code.  Don't forget to also set the CountryCode variable.
	*/
	...
	*/
	 ...
	 */
	@Override
	public SearchJobsByZipcodeAndCountryCodeResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchJobsByZipcodeAndCountryCodeResultSet(result);
	}
