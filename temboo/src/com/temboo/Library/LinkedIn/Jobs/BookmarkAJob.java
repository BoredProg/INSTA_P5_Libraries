...
*/
public class BookmarkAJob extends Choreography {

	/**
	Create a new instance of the BookmarkAJob Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public BookmarkAJob(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/LinkedIn/Jobs/BookmarkAJob"));
	}
	...
	*/
	 ...
	 */
	@Override
	public BookmarkAJobResultSet run() {
		JSONObject result = super.runWithResults();
		return new BookmarkAJobResultSet(result);
	}
