...
*/
public class GetUserProfile extends Choreography {

	/**
	Create a new instance of the GetUserProfile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUserProfile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/eBay/Shopping/GetUserProfile"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUserProfileResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUserProfileResultSet(result);
	}
