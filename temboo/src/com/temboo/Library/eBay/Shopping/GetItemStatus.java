...
*/
public class GetItemStatus extends Choreography {

	/**
	Create a new instance of the GetItemStatus Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetItemStatus(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/eBay/Shopping/GetItemStatus"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetItemStatusResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetItemStatusResultSet(result);
	}
