...
*/
public class GetEbayOfficialTime extends Choreography {

	/**
	Create a new instance of the GetEbayOfficialTime Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetEbayOfficialTime(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/eBay/Trading/GetEbayOfficialTime"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetEbayOfficialTimeResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetEbayOfficialTimeResultSet(result);
	}
