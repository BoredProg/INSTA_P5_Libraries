...
public class FindItemsAdvanced extends Choreography {
	...
	*/
	public FindItemsAdvanced(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/eBay/Finding/FindItemsAdvanced"));
	}
	...
	*/
	public void setFindItemsAdvancedRequest(String value) {
		this.inputs.setInput("FindItemsAdvancedRequest", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public FindItemsAdvancedResultSet run() {
		JSONObject result = super.runWithResults();
		return new FindItemsAdvancedResultSet(result);
	}
