...
*/
public class StructuredQuery extends Choreography {

	/**
	Create a new instance of the StructuredQuery Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public StructuredQuery(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/StructuredQuery"));
	}
	...
	*/
	 ...
	 */
	@Override
	public StructuredQueryResultSet run() {
		JSONObject result = super.runWithResults();
		return new StructuredQueryResultSet(result);
	}
