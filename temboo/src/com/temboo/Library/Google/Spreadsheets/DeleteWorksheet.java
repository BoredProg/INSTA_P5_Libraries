...
*/
public class DeleteWorksheet extends Choreography {

	/**
	Create a new instance of the DeleteWorksheet Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public DeleteWorksheet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/DeleteWorksheet"));
	}
	...
	*/
	 ...
	 */
	@Override
	public DeleteWorksheetResultSet run() {
		JSONObject result = super.runWithResults();
		return new DeleteWorksheetResultSet(result);
	}
