...
*/
public class AddWorksheet extends Choreography {

	/**
	Create a new instance of the AddWorksheet Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public AddWorksheet(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/AddWorksheet"));
	}
	...
	*/
	...
	@param String - (required, integer) The number of columns that you want to specify for the new worksheet.
	*/
	...
	*/
	...
	@param String - (required, integer) The number of rows that you want to specify for the new worksheet.
	*/
	...
	*/
	 ...
	 */
	@Override
	public AddWorksheetResultSet run() {
		JSONObject result = super.runWithResults();
		return new AddWorksheetResultSet(result);
	}
