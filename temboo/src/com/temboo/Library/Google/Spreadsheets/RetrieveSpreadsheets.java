...
*/
public class RetrieveSpreadsheets extends Choreography {

	/**
	Create a new instance of the RetrieveSpreadsheets Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveSpreadsheets(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/RetrieveSpreadsheets"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveSpreadsheetsResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveSpreadsheetsResultSet(result);
	}
