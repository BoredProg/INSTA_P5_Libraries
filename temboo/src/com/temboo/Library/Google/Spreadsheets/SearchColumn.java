...
public class SearchColumn extends Choreography {
	...
	*/
	...
	@param String - (optional, string) he Client ID provided by Google. Required when authenticating with OAuth unless providing a valid AccessToken.
	*/
	...
	*/
	public void setReturnMatches(Boolean value) {
		this.inputs.setInput("ReturnMatches", value);
	}
	...
	*/
	public void setSearchOperator(String value) {
		this.inputs.setInput("SearchOperator", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchColumnResultSet run() {
