...
*/
public class RetrieveCellFeed extends Choreography {

	/**
	Create a new instance of the RetrieveCellFeed Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveCellFeed(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/RetrieveCellFeed"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveCellFeedResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveCellFeedResultSet(result);
	}
