...
*/
public class RetrieveSpreadsheetDetailsByName extends Choreography {

	/**
	Create a new instance of the RetrieveSpreadsheetDetailsByName Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveSpreadsheetDetailsByName(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Spreadsheets/RetrieveSpreadsheetDetailsByName"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveSpreadsheetDetailsByNameResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveSpreadsheetDetailsByNameResultSet(result);
	}
