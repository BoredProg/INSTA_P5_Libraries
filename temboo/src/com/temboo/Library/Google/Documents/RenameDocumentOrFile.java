...
*/
public class RenameDocumentOrFile extends Choreography {

	/**
	Create a new instance of the RenameDocumentOrFile Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RenameDocumentOrFile(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Documents/RenameDocumentOrFile"));
	}
	...
	*/
	public void setNewTitle(String value) {
		this.inputs.setInput("NewTitle", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public RenameDocumentOrFileResultSet run() {
		JSONObject result = super.runWithResults();
		return new RenameDocumentOrFileResultSet(result);
	}
