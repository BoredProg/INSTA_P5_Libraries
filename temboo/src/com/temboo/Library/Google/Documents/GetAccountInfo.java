...
*/
public class GetAccountInfo extends Choreography {

	/**
	Create a new instance of the GetAccountInfo Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetAccountInfo(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Documents/GetAccountInfo"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetAccountInfoResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetAccountInfoResultSet(result);
	}
