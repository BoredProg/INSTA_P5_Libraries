...
*/
public class CopyDocument extends Choreography {

	/**
	Create a new instance of the CopyDocument Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public CopyDocument(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Documents/CopyDocument"));
	}
	...
	*/
	 ...
	 */
	@Override
	public CopyDocumentResultSet run() {
		JSONObject result = super.runWithResults();
		return new CopyDocumentResultSet(result);
	}
