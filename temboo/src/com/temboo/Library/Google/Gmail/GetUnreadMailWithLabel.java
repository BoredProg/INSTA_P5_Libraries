...
*/
public class GetUnreadMailWithLabel extends Choreography {

	/**
	Create a new instance of the GetUnreadMailWithLabel Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUnreadMailWithLabel(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmail/GetUnreadMailWithLabel"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUnreadMailWithLabelResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUnreadMailWithLabelResultSet(result);
	}
