...
*/
public class GetUnreadMailFromSender extends Choreography {

	/**
	Create a new instance of the GetUnreadMailFromSender Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetUnreadMailFromSender(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Google/Gmail/GetUnreadMailFromSender"));
	}
	...
	*/
	public void setSenderEmail(String value) {
		this.inputs.setInput("SenderEmail", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public GetUnreadMailFromSenderResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetUnreadMailFromSenderResultSet(result);
	}
