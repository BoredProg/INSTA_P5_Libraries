...
*/
public  class LookupPaymentResultSet extends ResultSet {
		
	public LookupPaymentResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getCurrency() {
		return this.getResultString("Currency");
	}
	/** 
	...
	*/
	public String getPaymentState() {
		return this.getResultString("PaymentState");
	}
	/** 
	...
	*/
	public String getSaleState() {
		return this.getResultString("SaleState");
	}
	/** 
	...
	*/
	public String getTotal() {
		return this.getResultString("Total");
	}
}