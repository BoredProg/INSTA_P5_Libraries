...
*/
public class GetClicksForLink extends Choreography {

	/**
	Create a new instance of the GetClicksForLink Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetClicksForLink(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Bitly/LinkMetrics/GetClicksForLink"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetClicksForLinkResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetClicksForLinkResultSet(result);
	}
