...
*/
public class GetReferrers extends Choreography {

	/**
	Create a new instance of the GetReferrers Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public GetReferrers(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Bitly/LinkMetrics/GetReferrers"));
	}
	...
	*/
	 ...
	 */
	@Override
	public GetReferrersResultSet run() {
		JSONObject result = super.runWithResults();
		return new GetReferrersResultSet(result);
	}
