...
public class SearchByCoordinates extends Choreography {
	...
	*/
	public SearchByCoordinates(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Yelp/SearchByCoordinates"));
	}

	/** 
	Set the value of the Accuracy input for this Choreo. 

	@param BigDecimal - (optional, decimal) Narrow or widen the search range in relation to the coordinates, such as "2" for state or "8" for street address.
	*/
	...
	@param String - (optional, decimal) Narrow or widen the search range in relation to the coordinates, such as "2" for state or "8" for street address.
	*/
	...
	*/
	...
	@param String - (required, decimal) The latitude to search near, such as "37.788022".
	*/
	...
	*/
	...
	@param String - (required, decimal) The longitude to search near, such as "-122.399797".
	*/
	...
	*/
	 ...
	 */
	@Override
	public SearchByCoordinatesResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchByCoordinatesResultSet(result);
	}
