...
public class SearchByNeighborhood extends Choreography {
	...
	*/
	public SearchByNeighborhood(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Yelp/SearchByNeighborhood"));
	}
	...
	*/
	public void setNeighborhood(String value) {
		this.inputs.setInput("Neighborhood", value);
	}
	...
	*/
	 ...
	 */
	@Override
	public SearchByNeighborhoodResultSet run() {
		JSONObject result = super.runWithResults();
		return new SearchByNeighborhoodResultSet(result);
	}
