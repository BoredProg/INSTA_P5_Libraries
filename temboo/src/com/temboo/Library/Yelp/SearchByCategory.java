...
public class SearchByCategory extends Choreography {
	...
	*/
	public SearchByCategory(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Yelp/SearchByCategory"));
	}

	/** 
	Set the value of the Category input for this Choreo. 

	@param String - (required, string) The category to filter search results with. This can be a list of comma delimited categories. For example, "bars,french". See Choreo description for a list of categories.
	*/
