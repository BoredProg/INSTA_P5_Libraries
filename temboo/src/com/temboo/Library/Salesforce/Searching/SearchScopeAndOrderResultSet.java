package com.temboo.Library.Salesforce.Searching;
...
*/
public  class SearchScopeAndOrderResultSet extends ResultSet {
		
	public SearchScopeAndOrderResultSet(JSONObject doc) {
		super(doc);
	}
