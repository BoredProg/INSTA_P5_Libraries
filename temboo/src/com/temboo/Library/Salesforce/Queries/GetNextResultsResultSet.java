package com.temboo.Library.Salesforce.Queries;
...
*/
public  class GetNextResultsResultSet extends ResultSet {
		
	public GetNextResultsResultSet(JSONObject doc) {
		super(doc);
	}
	...
	*/
	public String getNextQueryLocator() {
		return this.getResultString("NextQueryLocator");
	}
}