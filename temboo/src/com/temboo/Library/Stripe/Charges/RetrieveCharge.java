...
*/
public class RetrieveCharge extends Choreography {

	/**
	Create a new instance of the RetrieveCharge Choreo. A TembooSession object, containing a valid
	set of Temboo credentials, must be supplied.
	*/
	public RetrieveCharge(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Stripe/Charges/RetrieveCharge"));
	}
	...
	*/
	 ...
	 */
	@Override
	public RetrieveChargeResultSet run() {
		JSONObject result = super.runWithResults();
		return new RetrieveChargeResultSet(result);
	}
