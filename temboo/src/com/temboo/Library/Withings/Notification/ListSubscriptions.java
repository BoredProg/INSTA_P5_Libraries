...
public class ListSubscriptions extends Choreography {
	...
	*/
	public ListSubscriptions(TembooSession session) {
		super(session, TembooPath.pathFromStringNoException("/Library/Withings/Notification/ListSubscriptions"));
	}
	...
	*/
	...
	@param String - (optional, integer) Used to restrict the request to the given device type. Set to 1 for Bodyscale.
	*/
