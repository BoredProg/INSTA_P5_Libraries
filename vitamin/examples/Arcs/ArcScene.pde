...
//    _shadowTex = new VTexture2D( vgl.gl(), dataPath("sphereshadow.png") ); 
...
//    vgl.camera( 600, 300, 600, 0, 0, 0, 0, 1, 0 );
...
//    vgl.setTextureParameter( "ColorSampler", _earthMap.getId() );
...
//        a.update( time );
  ...
  public void Update( float time )
  {
    ...
    if( !offlineRenderSequence ) updateCamera( 10 );     
    else
    {
