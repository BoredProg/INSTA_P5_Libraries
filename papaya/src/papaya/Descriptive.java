 ...
 * http://adilapapaya.com/papayastatistics.html, 1
 * Created by Adila Faruk, http://adilapapaya.com, May 1st 2012
 *
 *
 * Copyright (C) 2012 Adila Faruk http://adilapapaya.com 
...
public class Descriptive extends Object {
	 ...
	 * previously computed variables such as the sum, sum of squares, and sum of
	 * powers.
	 */
		...
		public static float var(float[] data, float[] weights, boolean unbiased) {
			...
			Check.equalLengths(size,weights);
			  ...
			  */
			  ...
			  if(unbiased &&size>1) return varianceSum*weightSum/(weightSum*weightSum - weightSumSquared) ;
