...
void setup() {
  ...
  subdividor.setRange(0.7);// Random range of center offset, from 0 (no random) to 1(fully random)
...
void mousePressed(){
  mesh.modify(new HEM_EqualizeValence());
}
