...
public class Zone3d extends PApplet {
...
public void touchZ3D(){}

public void drawZ3D(Zone zone){
...
public void cylinder(float topRadius, float bottomRadius, float tall, int sides) {
  float angle = 0;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Zone3d" };
    if (passedArgs != null) {
